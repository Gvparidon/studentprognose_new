...
from scripts.load_data import load_oktober_file, load_latest
...
def calculate_first_year_student_counts(oktober_data, current_year):
    ...
    oktober_data = oktober_data[
        ...
        & (oktober_data["Collegejaar"] == current_year)
    ]
...
# --- Adds new prediction rows for the following year ---
def add_new_year(total_file, current_year):
    """
    Adds new prediction rows for the following year.
...
def main():
    ...
    data_total = add_new_year(data_total, current_year)
