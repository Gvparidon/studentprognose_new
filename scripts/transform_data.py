...
def create_total_file(
    ...
    data = data[
        [
            ...
            "SARIMA_cumulative",
            "SARIMA_individual",
            "Voorspelde vooraanmelders en inschrijvingen",
            "Voorspelde gewogen vooraanmelders",
        ]
    ]
...
def calculate_volume_predicted_data(
    ...
    data["Voorspelde vooraanmelders en inschrijvingen"] = np.nan
    data["Voorspelde gewogen vooraanmelders"] = np.nan
    ...
    data.loc[~predict_mask, "Voorspelde vooraanmelders en inschrijvingen"] = (
        data.loc[
            ~predict_mask,
    ...
    data.loc[~predict_mask, "Voorspelde gewogen vooraanmelders"] = (
        data.loc[
            ~predict_mask,
            ["Voorspelde gewogen vooraanmelders_x", "Voorspelde gewogen vooraanmelders_y"],
        ]
        .applymap(convert_nan_to_zero)
        .sum(axis=1)
    )
